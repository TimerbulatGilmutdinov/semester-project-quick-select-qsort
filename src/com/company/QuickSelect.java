...
public class QuickSelect {
    public static int quickSelectIterative(int[] array, int n) {
        return quickSelectIterativeHelper(array, 0, array.length - 1, n);
    }
     ...
     */
    public static int quickSelectRecursive(int[] array, int n) {
        return quickSelectRecursiveHelper(array, 0, array.length - 1, n);
    }
    ...
    private static int quickSelectRecursiveHelper(int[] array, int left, int right, int n) {
        ...
        if (n == pivotIndex) {
            ...
            return quickSelectRecursiveHelper(array, left, pivotIndex - 1, n);
        } else {
            return quickSelectIterativeHelper(array, pivotIndex + 1, right, n);
        }
    }
